...
:::{.fragment fragment-index=1 .right-align}
...
::: 
::: {.column width="20%"}
![](img/hall-effect-sensor.png){height=200 .absolute right=0 top=0}
::: 
::::
...
Limited turning range: 180 degrees]{.small-font}
...
arms or weight-carrying systems).]{.small-font}
